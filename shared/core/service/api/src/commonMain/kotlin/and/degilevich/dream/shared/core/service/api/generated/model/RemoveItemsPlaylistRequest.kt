 ...
 * 
 *
 * @param items An array of objects containing [Spotify URIs](/documentation/web-api/concepts/spotify-uris-ids) of the tracks or episodes to remove. For example: `{ \"items\": [{ \"uri\": \"spotify:track:4iV5W9uYEdYUVa79Axb7Rh\" },{ \"uri\": \"spotify:track:1301WleyT98MSxVHPZCA6M\" }] }`. A maximum of 100 objects can be sent at once. 
...
data class RemoveItemsPlaylistRequest (
    ...
    @SerialName(value = "items") @Required val items: kotlin.collections.List<RemoveTracksPlaylistRequestTracksInner>,
