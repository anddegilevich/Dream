...
import and.degilevich.dream.shared.foundation.decompose.component.store.SingleStoreComponent
...
abstract class DreamSingleStoreComponent<
    out UIState : Any,
    in Intent : Any,
    out SideEffect : Any,
    State : Any,
...
) : SingleStoreComponent<UIState, Intent, SideEffect, State>(
    componentContext = componentContext,
